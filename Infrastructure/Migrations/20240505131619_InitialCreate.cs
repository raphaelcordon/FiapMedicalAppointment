    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentSpan", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentSpanId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Appointment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Appointment_AppointmentSpan_AppointmentSpanId",
                        column: x => x.AppointmentSpanId,
                        principalTable: "AppointmentSpan",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointment_AppointmentSpan_AppointmentSpanId1",
                        column: x => x.AppointmentSpanId1,
                        principalTable: "AppointmentSpan",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DoctorsUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalSpecialtiesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorMedicalSpecialty", x => new { x.DoctorsUserId, x.MedicalSpecialtiesId });
                    table.ForeignKey(
                        name: "FK_DoctorMedicalSpecialty_Doctor_DoctorsUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointment_AppointmentSpanId",
                table: "Appointment",
                column: "AppointmentSpanId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointment_AppointmentSpanId1",
                table: "Appointment",
                column: "AppointmentSpanId1",
                unique: true,
                filter: "[AppointmentSpanId1] IS NOT NULL");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Doctor_DoctorUserId",
                table: "AspNetUsers",
                column: "DoctorUserId",
                principalTable: "Doctor",
                principalColumn: "UserId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Patient_PatientUserId",
                table: "AspNetUsers",
                column: "PatientUserId",
                principalTable: "Patient",
                principalColumn: "UserId",
